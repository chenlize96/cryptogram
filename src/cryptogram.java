...
public class cryptogram {
	...
	private static List<Character> original;
	private static Map<Character, Character> encryption;
	private static List<Character> encoded;
	private static List<Character> decoded;
	 ...
	 */
	public static boolean process(String strCommand) {
	 ...
	 */
	public static Map<Character, Integer> getFreq(List<Character> encoded) {
	 ...
	 * @param encoded     the encoded row
	 */	
	public static void execute(int index, Map<Character, Character> encryption,
			Map<Character, Character> record, List<Character> encoded) {
		if (index == 1) {
			getFreq(encoded);
		}else if (index == 2) {
	 ...
	 */	
	public static List<Character> startUp(List<Character> encodedList, 
	 ...
	 */	
	public static List<Character> decode(Map<Character, Character> record, 
	 ...
	 */	
	private static boolean checkChar(String aChar) {
	 ...
	 */	
	public static List<String> display(List<Character> encoded) {
	 ...
	 */	
	public static List<String> print(List<Character> encoded, 
	 ...
	 */	
	public static List<Character> encode(Map<Character, Character> encryption, 
	 ...
	 */	
	public static List<Character> selectRandomRow(List<String> rows){
